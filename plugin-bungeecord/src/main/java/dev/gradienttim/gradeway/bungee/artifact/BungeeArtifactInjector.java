...
*/
package dev.gradienttim.gradeway.bungee.artifact;
...
public class BungeeArtifactInjector implements ArtifactInjector {
    protected GradewayPlugin plugin;

    public BungeeArtifactInjector(GradewayPlugin plugin) {
        this.plugin = plugin;
    }
