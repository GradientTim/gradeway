...
*/
package dev.gradienttim.gradeway.utilities.serialize
...
interface JsonSerializable<T> {
    /**
     * Serializes the given data of type `T` into a `JsonObject` representation.
     *
     ...
     *
     * @param data The object of type `T` to be serialized into a `JsonObject`.
     * @return A `JsonObject` representing the serialized form of the input object.
     */
    fun serialize(data: T): JsonObject

    /**
     * Deserializes the given `JsonObject` into data of type `T`.
     *
     ...
     *
     * @param json The `JsonObject` containing the data to be deserialized into data of type `T`.
     * @return Data of type `T` reconstructed from the given `JsonObject`.
     */
